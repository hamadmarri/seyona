angular.module('phonertcdemo')
  .factory('CountryService', function () {
    ...
    var countris = [
      ...
      {name: 'Brazil', code: 'BR', flag: '0063', online: 0, welcome: "Wow! you're from Brazil!"},
      ...
      {name: 'Canada', code: 'CA', flag: '0070', online: 0, welcome: "Wow! you're from Canada!"},
     ...
     {name: 'France', code: 'FR', flag: '0111', online: 0, welcome: "Wow! you're from France!"},
     ...
     {name: 'India', code: 'IN', flag: '0142', online: 0, welcome: "Wow! you're from India!"},
     {name: 'Indonesia', code: 'ID', flag: '0138', online: 0, welcome: "Wow! you're from Indonesia!"},
     ...
     {name: 'Pakistan', code: 'PK', flag: '0215', online: 0, welcome: "Wow! you're from Pakistan!"},
     ...
     {name: 'Turkey', code: 'TR', flag: '0263', online: 0, welcome: "Wow! you're from Turkey!"},
     ...
     {name: 'United Arab Emirates', code: 'AE', flag: '0034', online: 0, welcome: "Wow! you're from United Arab Emirates!"},
     {name: 'United Kingdom', code: 'GB', flag: '0113', online: 0, welcome: "Wow! you're from United Kingdom!"},
     {name: 'United States', code: 'US', flag: '0270', online: 0, welcome: "Wow! you're from United States!"},
